// Direct CommonJS / Node.js test runner for canonical LLM sanitizer
const fs = require('fs');
const path = require('path');

// Dynamically read and compile src/lib/sanitizeLLM.ts or test the logic directly
...
assertEqual('13. Metadata includes sanitizer version', meta.version, SANITIZER_VERSION);
...
assertEqual('14. Evaluation numeric score preserved', cleanedEval.overall_score, 85);
assertEqual('15. Evaluation summary sanitized', cleanedEval.summary, 'Strong grasp of system design.');
assertEqual('16. Evaluation strengths sanitized', cleanedEval.strengths[0], 'Clear articulation');
...
assertEqual(
  '17. StreamingTextSanitizer properly handles tags split across chunks',
  streamedResult.trim(),
