...
export default function MissionCard({ mission, onComplete }: { mission: Mission; onComplete: () => void }) {
  ...
  async function submit() {
    ...
    setLoading(true);
    try {
      await api.post('/api/missions/submit', { 
  ...
  return (
    ...
    >
      ...
      {mission.source_weakness && (
        <div style={{ fontSize: 10.5, color: 'var(--t3)', fontFamily: 'var(--font-mono)', marginBottom: 8 }}>
      ...
      {expanded && !isDone && (
        <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid var(--border)' }}>
          ...
          <textarea 
            ...
            placeholder="Describe what you did, what you learned, or paste your work here…" 
            rows={4} 
            style={{ width: '100%', background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 8, padding: '10px 12px', color: 'var(--t1)', fontSize: 12.5, outline: 'none', resize: 'vertical', lineHeight: 1.6, boxSizing: 'border-box' }}
          />
