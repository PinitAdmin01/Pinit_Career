        ...
        <div style={{ background: '#fff', padding: 24, borderRadius: 16, border: '1px solid #cbd5e1', display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {!examSubmitted ? (
                    ...
                    {q.options.map((opt, optIdx) => (
                      <button
                        ...
                        style={{
                          padding: '10px 14px',
                          borderRadius: 8,
                          border: `2px solid ${answers[q.id] === optIdx ? 'var(--info)' : '#cbd5e1'}`,
            ...
            <div style={{ textAlign: 'center', padding: 32 }}>
              ...
              <p style={{ color: 'var(--text-dim)', fontSize: 14 }}>Your answers have been submitted securely to your instructor.</p>
