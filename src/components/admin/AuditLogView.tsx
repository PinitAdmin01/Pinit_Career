...
export default function AuditLogView() {
  const [logs] = useState<AuditLog[]>([
    ...
    { id: 'LOG-1093', adminName: 'Lead Recruiter', action: 'INTERVIEW_DISPATCH', target: 'Candidate Student', timestamp: new Date(Date.now() - 600000).toLocaleString(), details: 'Sent interview invitation Ref #REF-INV-2026-9182' },
