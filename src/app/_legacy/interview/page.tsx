...
type InterviewStage = 'welcome' | 'coding' | 'complexity' | 'scenario' | 'completed';
        ...
        <div style={{
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', background: 'var(--bg2)' }}>
            ...
            {interviewStage === 'welcome' && (
              <div style={{ display: 'flex', padding: '10px 14px', background: 'var(--bg3)', borderTop: '1px solid var(--border)', gap: 10 }}>
                <button
            ...
            >
              ...
              <button
                type="submit"
                disabled={!input.trim() || loading || interviewStage === 'welcome' || interviewStage === 'completed'}
                style={{
            ...
            {interviewStage === 'completed' && (
              <div style={{ padding: '12px 14px', borderTop: '1px solid var(--border)', background: 'var(--bg3)', display: 'flex', gap: 10 }}>
                <Link href="/career-twin" className="btn-primary btn-sm" style={{ flex: 1, justifyContent: 'center' }}>
                  Explore Career Twin 🧬
                </Link>
                <Link href="/sentinel" className="btn-ghost btn-sm" style={{ flex: 1, justifyContent: 'center' }}>
                  Open Sentinel 🔐
                </Link>
              </div>
            )}
