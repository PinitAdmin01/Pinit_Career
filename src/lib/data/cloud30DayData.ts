...
export const CLOUD_30_DAYS_CONFIGS: DayConfig[] = [
  {
    ...
    "eStarter": "function getResponsibilityOwner(cloudLayer, serviceModel) {\n  // Physical datacenter is always AWS; on IaaS customer manages OS patching and app code; on SaaS AWS manages everything except customer data.\n  \n}",
    ...
    "aStarter": "function categorizeCloudModel(service) {\n  // Map EC2/EBS to IaaS, RDS/Beanstalk to PaaS, WorkDocs to SaaS.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function isTopologyFaultTolerant(nodes) {\n  // Count distinct availabilityZone values across nodes using a Set.\n  \n}",
    ...
    "aStarter": "function isValidAwsRegion(code) {\n  // Verify standard pattern like us-east-1, eu-west-1, ap-south-1.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function getUsableSubnetIps(cidrMask) {\n  // Total IPs is 2^(32 - mask); deduct 5 AWS reserved IPs.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function evaluateSecurityGroupTraffic(rules, packet) {\n  // Return traffic is automatically allowed due to stateful connection tracking.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function validateVpcTopology(cfg) {\n  // Verify at least 2 AZs, 2 public, 2 private, hasInternetGateway, and hasNatGateway.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function evaluateIamPermission(statements, req) {\n  // Iterate statements; if explicit Deny matches, return DENY immediately; default is Implicit Deny.\n  \n}",
  ...
  },
  {
    ...
    "aStarter": "function isSpotInterruptionImminent(noticeMin) {\n  // AWS Spot instances receive a 2-minute termination warning.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function resolveS3StorageClass(ageDays, freq) {\n  // Map <30d to STANDARD, 30-90d infrequent to IA, >=90d to GLACIER, >=365d to DEEP ARCHIVE.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function validateS3BucketPolicy(policy) {\n  // Look for Deny statement with Condition Bool aws:SecureTransport === 'false'.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function getLambdaVcpu(memoryMb) {\n  // Divide memoryMb by 1769 and format to 2 decimal places.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "async function orchestrateVideoPipeline(event, db, transcoder) {\n  // Extract bucket and key, check .mp4 extension, record in DB, and execute transcoder.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function resolveDnsEndpoint(cfg, isPrimaryHealthy) {\n  // If policy is FAILOVER, return primaryIp when healthy, else secondaryIp.\n  \n}",
  ...
  },
  {
    ...
    "aStarter": "function buildFifoMessage(body, groupId, dedupId) {\n  // Return object with MessageBody, MessageGroupId, MessageDeduplicationId.\n  \n}",
  ...
  },
  {
    ...
    "aStarter": "function matchesFilterPolicy(policy, attrs) {\n  // Check all policy keys exist in attrs and match values.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function routeMicroserviceEvent(event, rules, queues) {\n  // Match rule source and detailType; push event.detail to target queue in map.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function validateFargateTaskSize(cpu, memory) {\n  // Verify 256 CPU supports 512-2048MB, 512 CPU supports 1024-4096MB, 1024 CPU supports 2048-8192MB.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "async function executeSagaWorkflow(steps, ctx) {\n  // Execute steps; on error, iterate executed in reverse calling compensate().\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "class TerraformStateLock {\n  constructor() {\n    // Store currentLock object; reject acquireLock if lock exists with different ID.\n    \n  }\n  acquireLock(lockId, info) {\n    // Store currentLock object; reject acquireLock if lock exists with different ID.\n    \n  }\n  releaseLock(lockId) {\n    // Store currentLock object; reject acquireLock if lock exists with different ID.\n    \n  }\n\n}",
  ...
  },
  {
    ...
    "eStarter": "function evaluateCloudWatchAlarm(points, threshold, op, periods) {\n  // Slice last evaluationPeriods points; if all points breach threshold, return ALARM, else OK.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function simulateEnvelopeEncryption(plaintext, kmk) {\n  // Generate plaintext DEK, encrypt data with DEK, encrypt DEK with master key (KMK), and return envelope package.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function inspectWafRequest(rules, req) {\n  // Inspect request against rate limit, SQLi patterns, and blocked countries.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function calculateCloudBill(totalHours, spRate, odRate, spCommitHours) {\n  // Multiply covered hours by savings plan rate and remaining excess by on-demand rate.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function selectDrStrategy(rtoMin, rpoMin) {\n  // Map sub-minute zero-downtime to MultiSiteActiveActive, <=15m to WarmStandby, <=2h to PilotLight, else BackupAndRestore.\n  \n}",
  ...
  },
  {
    ...
    "eStarter": "function routeGlobalBankingTransaction(regions, payload) {\n  // Filter healthy regions, sort by latencyMs ascending, and route to closest region.\n  \n}",
