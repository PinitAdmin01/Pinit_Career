...
export const DSA_30_DAYS_CONFIGS: DayConfig[] = [
  ...
  },
  {
    ...
    "aTitle": "Two Sum Optimal Complement Search with Direct Index Lookup",
  ...
  },
  {
    ...
    "eDesc": "Implement `function levelOrder(root)` performing breadth-first search and returning a 2D array of node values grouped level by level.",
