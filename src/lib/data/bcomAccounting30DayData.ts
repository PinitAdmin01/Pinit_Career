...
export const BCOM_ACCOUNTING_30_DAYS_CONFIGS: DayConfig[] = [
  {
    ...
    "aStarter": "function solveEquity(a, l) { return a - l; }",
  ...
  },
  {
    ...
    "aStarter": "function formatNominalIncome() { return 'CREDIT_INCOMES_AND_GAINS'; }",
  ...
  },
  {
    ...
    "aStarter": "function sumLines(lines) { return lines.reduce((s, l) => s + l.amount, 0); }",
  ...
  },
  {
    ...
    "aStarter": "function formatBalanceType(d, c) { return d >= c ? 'DR_BALANCE' : 'CR_BALANCE'; }",
  ...
  },
  {
    ...
    "aStarter": "function formatBookkeepingState(b) { return `BOOKS_${b ? 'BALANCED' : 'IMBALANCED'}`; }",
  ...
  },
  {
    ...
    "aStarter": "function getContraMarker() { return 'C'; }",
    "aHint": "Return 'C'.",
  ...
  },
  {
    ...
    "aStarter": "function formatNoteDoc(t) { return t === 'PURCHASE_RETURN' ? 'DEBIT_NOTE' : 'CREDIT_NOTE'; }",
  ...
  },
  {
    ...
    "aStarter": "function formatPassbookSign(b) { return b >= 0 ? 'CREDIT_FAVORABLE' : 'DEBIT_OVERDRAFT'; }",
  ...
  },
  {
    ...
    "aStarter": "function classifyTbError(n) { return n === 'ERROR_OF_PRINCIPLE' ? 'DOES_NOT_AFFECT_TRIAL_BALANCE' : 'AFFECTS_TRIAL_BALANCE'; }",
  ...
  },
  {
    ...
    "aStarter": "function formatSuspenseStatus(b) { return b === 0 ? 'SUSPENSE_ACCOUNT_CLEARED' : 'SUSPENSE_REMAINS_ACTIVE'; }",
  ...
  },
  {
    ...
    "aStarter": "function getDepreciationStandard() { return 'AS_10_PROPERTY_PLANT_EQUIPMENT'; }",
    "aHint": "Return AS-10.",
  ...
  },
  {
    ...
    "aStarter": "function formatCogsFormula() { return 'COGS = Opening Stock + Net Purchases + Direct Expenses - Closing Stock'; }",
  ...
  },
  {
    ...
    "aStarter": "function getNetProfitDestination() { return 'OWNERS_CAPITAL_ACCOUNT'; }",
  ...
  },
  {
    ...
    "aStarter": "function getWorkingCapitalFormula() { return 'Working Capital = Current Assets - Current Liabilities'; }",
  ...
  },
  {
    ...
    "aStarter": "function formatReportingStandard() { return 'SCHEDULE_III_COMPANIES_ACT_2013'; }",
  ...
  },
  {
    ...
    "aStarter": "function getTallyPrimaryGroupsCount() { return 15; }",
    "aHint": "Return 15.",
  ...
  },
  {
    ...
    "aStarter": "function getPaymentShortcut() { return 'F5'; }",
    "aHint": "Return 'F5'.",
  ...
  },
  {
    ...
    "aStarter": "function getIntraStateGstComponents() { return ['CGST', 'SGST']; }",
  ...
  },
  {
    ...
    "aStarter": "function canCgstOffsetSgst() { return false; }",
  ...
  },
  {
    ...
    "aStarter": "function getGstr1DueDate() { return '11TH_OF_NEXT_MONTH'; }",
    "aHint": "Return 11th.",
  ...
  },
  {
    ...
    "aStarter": "function formatGstStatus(c) { return `GST_COMPLIANCE_${c ? 'VERIFIED' : 'DEFAULT'}`; }",
  ...
  },
  {
    ...
    "aStarter": "function getEwayBillThreshold() { return 50000; }",
    "aHint": "Return 50000.",
  ...
  },
  {
    ...
    "aStarter": "function getEpfRate() { return 0.12; }",
  ...
  },
  {
    ...
    "aStarter": "function getTdsChallan() { return 'ITNS_281'; }",
  ...
  },
  {
    ...
    "aStarter": "function getNewRegimeSection() { return 'SECTION_115BAC'; }",
  ...
  },
  {
    ...
    "aStarter": "function getCorporateEffectiveRate() { return 25.168; }",
    "aHint": "Return 25.168.",
  ...
  },
  {
    ...
    "aStarter": "function getStandardCurrentRatio() { return '2:1'; }",
    "aHint": "Return '2:1'.",
  ...
  },
  {
    ...
    "aStarter": "function getCashFlowStandard() { return 'AS_3_CASH_FLOW_STATEMENTS'; }",
    "aHint": "Return AS-3.",
  ...
  },
  {
    ...
    "aStarter": "function getForensicAccountingLaw() { return 'BENFORDS_LAW_FIRST_DIGIT_DISTRIBUTION'; }",
  ...
  },
  {
    ...
    "aStarter": "function auditAccountingMasterCert() { return { certified: true, score: '100/100', tier: 'ENTERPRISE_DIGITAL_ACCOUNTANT_MASTER_CERTIFIED' }; }",
